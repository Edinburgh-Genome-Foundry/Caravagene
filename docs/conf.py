...
htmlhelp_basename = 'Caravagenedoc'
...
latex_documents = [
  ('index', 'Caravagene.tex', u'Caravagene Documentation',
   u'Zulko', 'manual'),
]
...
man_pages = [
    ('index', 'Caravagene', u'PACKAGE_NAME Documentation',
     [u'Zulko'], 1)
]
...
texinfo_documents = [
  ('index', 'Caravagene', u'Caravagene Documentation',
   u'Zulko', 'Caravagene', 'One line description of project.',
   'Miscellaneous'),
]
